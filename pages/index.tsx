        ...
        <>
            ...
            <div className='container mx-auto my-20 xl:w-2/3 flex flex-row flex-wrap p-2'>
                <div className='w-full flex'>
                    ...
                    <div className='flex flex-grow justify-end w-auto'>
                        <div className='flex flex-row flex-wrap w-full md:w-56 lg:w-full justify-end content-end'>
                            ...
                            >
                                <Box
                                    ...
                                    size='small'
                                    width='square'
                                    className='justify-center items-center flex text-center text-sm sm:text-base'
                ...
                <Box color='white' width='full'>
                    <a href='https://exam.loukhin.com.nopdon.tanssw.com.iamkanz.ktnis.me' className='hover:text-yellow-400 duration-100'>บางละเมียด</a>
                </Box>
            </div>
            <style jsx global>{`
                span.transparent {
